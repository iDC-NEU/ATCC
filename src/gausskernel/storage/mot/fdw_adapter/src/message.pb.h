...
class LockInfo_Row;
class LockInfo_RowDefaultTypeInternal;
extern LockInfo_RowDefaultTypeInternal _LockInfo_Row_default_instance_;
...
template<> ::merge::LockInfo* Arena::CreateMaybeMessage<::merge::LockInfo>(Arena*);
template<> ::merge::LockInfo_Row* Arena::CreateMaybeMessage<::merge::LockInfo_Row>(Arena*);
...
class Transaction_Row :
 ...
 public:
  ...
  enum : int {
    ...
    kDataFieldNumber = 5,
    kTypeFieldNumber = 3,
    kIsInteractiveRowFieldNumber = 6,
  };
  ...
  // bool isInteractiveRow = 6;
  void clear_isinteractiverow();
  bool isinteractiverow() const;
  void set_isinteractiverow(bool value);
  private:
  bool _internal_isinteractiverow() const;
  void _internal_set_isinteractiverow(bool value);
  public:
...
class Transaction :
 ...
 public:
  ...
  void clear_lockinfocount();
  ::PROTOBUF_NAMESPACE_ID::uint64 lockinfocount() const;
  void set_lockinfocount(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_lockinfocount() const;
  void _internal_set_lockinfocount(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:

  // bool isInteractive = 7;
  void clear_isinteractive();
  bool isinteractive() const;
  void set_isinteractive(bool value);
  private:
  bool _internal_isinteractive() const;
...
class LockInfo_Row :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:merge.LockInfo.Row) */ {
 public:
  LockInfo_Row();
  virtual ~LockInfo_Row();

  LockInfo_Row(const LockInfo_Row& from);
  LockInfo_Row(LockInfo_Row&& from) noexcept
    : LockInfo_Row() {
    *this = ::std::move(from);
  }

  inline LockInfo_Row& operator=(const LockInfo_Row& from) {
    CopyFrom(from);
    return *this;
  }
  inline LockInfo_Row& operator=(LockInfo_Row&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const LockInfo_Row& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const LockInfo_Row* internal_default_instance() {
    return reinterpret_cast<const LockInfo_Row*>(
               &_LockInfo_Row_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(LockInfo_Row& a, LockInfo_Row& b) {
    a.Swap(&b);
  }
  inline void Swap(LockInfo_Row* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline LockInfo_Row* New() const final {
    return CreateMaybeMessage<LockInfo_Row>(nullptr);
  }

  LockInfo_Row* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<LockInfo_Row>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const LockInfo_Row& from);
  void MergeFrom(const LockInfo_Row& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(LockInfo_Row* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "merge.LockInfo.Row";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:merge.LockInfo.Row)
 private:
  class _Internal;
...
class LockInfo :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:merge.LockInfo) */ {
 public:
  LockInfo();
  virtual ~LockInfo();
  ...
  public:
  void clear_row();
  ::merge::LockInfo_Row* mutable_row(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::merge::LockInfo_Row >*
      mutable_row();
  private:
  const ::merge::LockInfo_Row& _internal_row(int index) const;
  ::merge::LockInfo_Row* _internal_add_row();
  public:
  const ::merge::LockInfo_Row& row(int index) const;
  ::merge::LockInfo_Row* add_row();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::merge::LockInfo_Row >&
      row() const;
  ...
  // @@protoc_insertion_point(class_scope:merge.LockInfo)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::merge::LockInfo_Row > row_;
  ::PROTOBUF_NAMESPACE_ID::uint64 startepoch_;
  ::PROTOBUF_NAMESPACE_ID::uint64 commitepoch_;
  ::PROTOBUF_NAMESPACE_ID::uint64 csn_;
  ::PROTOBUF_NAMESPACE_ID::uint64 server_id_;
...
class Message :
 ...
 public:
  ...
  // .merge.LockInfo lockinfo = 4;
  bool has_lockinfo() const;
  private:
  bool _internal_has_lockinfo() const;
  public:
  void clear_lockinfo();
  const ::merge::LockInfo& lockinfo() const;
  ::merge::LockInfo* release_lockinfo();
  ::merge::LockInfo* mutable_lockinfo();
  void set_allocated_lockinfo(::merge::LockInfo* lockinfo);
  private:
  const ::merge::LockInfo& _internal_lockinfo() const;
...
// bool isInteractiveRow = 6;
inline void Transaction_Row::clear_isinteractiverow() {
  isinteractiverow_ = false;
}
inline bool Transaction_Row::_internal_isinteractiverow() const {
  return isinteractiverow_;
}
inline bool Transaction_Row::isinteractiverow() const {
  // @@protoc_insertion_point(field_get:merge.Transaction.Row.isInteractiveRow)
  return _internal_isinteractiverow();
}
inline void Transaction_Row::_internal_set_isinteractiverow(bool value) {
  
  isinteractiverow_ = value;
}
inline void Transaction_Row::set_isinteractiverow(bool value) {
  _internal_set_isinteractiverow(value);
  // @@protoc_insertion_point(field_set:merge.Transaction.Row.isInteractiveRow)
}
...
// bool isInteractive = 7;
inline void Transaction::clear_isinteractive() {
  isinteractive_ = false;
}
inline bool Transaction::_internal_isinteractive() const {
  return isinteractive_;
}
inline bool Transaction::isinteractive() const {
  // @@protoc_insertion_point(field_get:merge.Transaction.isInteractive)
  return _internal_isinteractive();
}
inline void Transaction::_internal_set_isinteractive(bool value) {
  
  isinteractive_ = value;
}
inline void Transaction::set_isinteractive(bool value) {
  _internal_set_isinteractive(value);
  // @@protoc_insertion_point(field_set:merge.Transaction.isInteractive)
}

// uint64 lockInfoCount = 8;
inline void Transaction::clear_lockinfocount() {
  lockinfocount_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Transaction::_internal_lockinfocount() const {
  return lockinfocount_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Transaction::lockinfocount() const {
  // @@protoc_insertion_point(field_get:merge.Transaction.lockInfoCount)
  return _internal_lockinfocount();
}
inline void Transaction::_internal_set_lockinfocount(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  lockinfocount_ = value;
}
inline void Transaction::set_lockinfocount(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_lockinfocount(value);
...
// string tableName = 1;
inline void LockInfo_Row::clear_tablename() {
  tablename_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LockInfo_Row::tablename() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.Row.tableName)
  return _internal_tablename();
}
inline void LockInfo_Row::set_tablename(const std::string& value) {
  _internal_set_tablename(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.Row.tableName)
}
inline std::string* LockInfo_Row::mutable_tablename() {
  // @@protoc_insertion_point(field_mutable:merge.LockInfo.Row.tableName)
  return _internal_mutable_tablename();
}
inline const std::string& LockInfo_Row::_internal_tablename() const {
  return tablename_.GetNoArena();
}
inline void LockInfo_Row::_internal_set_tablename(const std::string& value) {
  
  tablename_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LockInfo_Row::set_tablename(std::string&& value) {
  
  tablename_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:merge.LockInfo.Row.tableName)
}
inline void LockInfo_Row::set_tablename(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  tablename_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:merge.LockInfo.Row.tableName)
}
inline void LockInfo_Row::set_tablename(const char* value, size_t size) {
  
  tablename_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:merge.LockInfo.Row.tableName)
}
inline std::string* LockInfo_Row::_internal_mutable_tablename() {
  
  return tablename_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LockInfo_Row::release_tablename() {
  // @@protoc_insertion_point(field_release:merge.LockInfo.Row.tableName)
  
  return tablename_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LockInfo_Row::set_allocated_tablename(std::string* tablename) {
  if (tablename != nullptr) {
  ...
  tablename_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), tablename);
  // @@protoc_insertion_point(field_set_allocated:merge.LockInfo.Row.tableName)
}

// bytes key = 2;
inline void LockInfo_Row::clear_key() {
  key_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LockInfo_Row::key() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.Row.key)
  return _internal_key();
}
inline void LockInfo_Row::set_key(const std::string& value) {
  _internal_set_key(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.Row.key)
}
inline std::string* LockInfo_Row::mutable_key() {
  // @@protoc_insertion_point(field_mutable:merge.LockInfo.Row.key)
  return _internal_mutable_key();
}
inline const std::string& LockInfo_Row::_internal_key() const {
  return key_.GetNoArena();
}
inline void LockInfo_Row::_internal_set_key(const std::string& value) {
  
  key_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LockInfo_Row::set_key(std::string&& value) {
  
  key_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:merge.LockInfo.Row.key)
}
inline void LockInfo_Row::set_key(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  key_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:merge.LockInfo.Row.key)
}
inline void LockInfo_Row::set_key(const void* value, size_t size) {
  
  key_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:merge.LockInfo.Row.key)
}
inline std::string* LockInfo_Row::_internal_mutable_key() {
  
  return key_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LockInfo_Row::release_key() {
  // @@protoc_insertion_point(field_release:merge.LockInfo.Row.key)
  
  return key_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LockInfo_Row::set_allocated_key(std::string* key) {
  if (key != nullptr) {
  ...
  key_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), key);
  // @@protoc_insertion_point(field_set_allocated:merge.LockInfo.Row.key)
}

// uint32 type = 3;
inline void LockInfo_Row::clear_type() {
  type_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 LockInfo_Row::_internal_type() const {
  return type_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 LockInfo_Row::type() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.Row.type)
  return _internal_type();
}
inline void LockInfo_Row::_internal_set_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  type_ = value;
}
inline void LockInfo_Row::set_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.Row.type)
}

// bytes data = 4;
inline void LockInfo_Row::clear_data() {
  data_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LockInfo_Row::data() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.Row.data)
  return _internal_data();
}
inline void LockInfo_Row::set_data(const std::string& value) {
  _internal_set_data(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.Row.data)
}
inline std::string* LockInfo_Row::mutable_data() {
  // @@protoc_insertion_point(field_mutable:merge.LockInfo.Row.data)
  return _internal_mutable_data();
}
inline const std::string& LockInfo_Row::_internal_data() const {
  return data_.GetNoArena();
}
inline void LockInfo_Row::_internal_set_data(const std::string& value) {
  
  data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LockInfo_Row::set_data(std::string&& value) {
  
  data_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:merge.LockInfo.Row.data)
}
inline void LockInfo_Row::set_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:merge.LockInfo.Row.data)
}
inline void LockInfo_Row::set_data(const void* value, size_t size) {
  
  data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:merge.LockInfo.Row.data)
}
inline std::string* LockInfo_Row::_internal_mutable_data() {
  
  return data_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LockInfo_Row::release_data() {
  // @@protoc_insertion_point(field_release:merge.LockInfo.Row.data)
  
  return data_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LockInfo_Row::set_allocated_data(std::string* data) {
  if (data != nullptr) {
  ...
  data_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data);
  // @@protoc_insertion_point(field_set_allocated:merge.LockInfo.Row.data)
}
...
// repeated .merge.LockInfo.Row row = 1;
inline int LockInfo::_internal_row_size() const {
  return row_.size();
}
inline int LockInfo::row_size() const {
  return _internal_row_size();
}
inline void LockInfo::clear_row() {
  row_.Clear();
}
inline ::merge::LockInfo_Row* LockInfo::mutable_row(int index) {
  // @@protoc_insertion_point(field_mutable:merge.LockInfo.row)
  return row_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::merge::LockInfo_Row >*
LockInfo::mutable_row() {
  // @@protoc_insertion_point(field_mutable_list:merge.LockInfo.row)
  return &row_;
}
inline const ::merge::LockInfo_Row& LockInfo::_internal_row(int index) const {
  return row_.Get(index);
}
inline const ::merge::LockInfo_Row& LockInfo::row(int index) const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.row)
  return _internal_row(index);
}
inline ::merge::LockInfo_Row* LockInfo::_internal_add_row() {
  return row_.Add();
}
inline ::merge::LockInfo_Row* LockInfo::add_row() {
  // @@protoc_insertion_point(field_add:merge.LockInfo.row)
  return _internal_add_row();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::merge::LockInfo_Row >&
LockInfo::row() const {
  // @@protoc_insertion_point(field_list:merge.LockInfo.row)
  return row_;
}

// uint64 StartEpoch = 2;
inline void LockInfo::clear_startepoch() {
  startepoch_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::_internal_startepoch() const {
  return startepoch_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::startepoch() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.StartEpoch)
  return _internal_startepoch();
}
inline void LockInfo::_internal_set_startepoch(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  startepoch_ = value;
}
inline void LockInfo::set_startepoch(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_startepoch(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.StartEpoch)
}

// uint64 CommitEpoch = 3;
inline void LockInfo::clear_commitepoch() {
  commitepoch_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::_internal_commitepoch() const {
  return commitepoch_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::commitepoch() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.CommitEpoch)
  return _internal_commitepoch();
}
inline void LockInfo::_internal_set_commitepoch(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  commitepoch_ = value;
}
inline void LockInfo::set_commitepoch(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_commitepoch(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.CommitEpoch)
}

// uint64 CSN = 4;
inline void LockInfo::clear_csn() {
  csn_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::_internal_csn() const {
  return csn_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::csn() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.CSN)
  return _internal_csn();
}
inline void LockInfo::_internal_set_csn(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  csn_ = value;
}
inline void LockInfo::set_csn(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_csn(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.CSN)
}

// uint64 server_id = 5;
inline void LockInfo::clear_server_id() {
  server_id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::_internal_server_id() const {
  return server_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::server_id() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.server_id)
  return _internal_server_id();
}
inline void LockInfo::_internal_set_server_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  server_id_ = value;
}
inline void LockInfo::set_server_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_server_id(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.server_id)
}

// uint64 txnid = 6;
inline void LockInfo::clear_txnid() {
  txnid_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::_internal_txnid() const {
  return txnid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 LockInfo::txnid() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.txnid)
  return _internal_txnid();
}
inline void LockInfo::_internal_set_txnid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  txnid_ = value;
}
inline void LockInfo::set_txnid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_txnid(value);
...
inline bool LockInfo::_internal_islock() const {
  return islock_;
}
inline bool LockInfo::islock() const {
  // @@protoc_insertion_point(field_get:merge.LockInfo.isLock)
  return _internal_islock();
}
inline void LockInfo::_internal_set_islock(bool value) {
  
  islock_ = value;
}
inline void LockInfo::set_islock(bool value) {
  _internal_set_islock(value);
  // @@protoc_insertion_point(field_set:merge.LockInfo.isLock)
}
...
// .merge.LockInfo lockinfo = 4;
inline bool Message::_internal_has_lockinfo() const {
  return type_case() == kLockinfo;
}
inline bool Message::has_lockinfo() const {
  return _internal_has_lockinfo();
}
inline void Message::set_has_lockinfo() {
  _oneof_case_[0] = kLockinfo;
}
inline void Message::clear_lockinfo() {
  if (_internal_has_lockinfo()) {
    delete type_.lockinfo_;
    clear_has_type();
  }
}
inline ::merge::LockInfo* Message::release_lockinfo() {
  // @@protoc_insertion_point(field_release:merge.Message.lockinfo)
  if (_internal_has_lockinfo()) {
    clear_has_type();
      ::merge::LockInfo* temp = type_.lockinfo_;
    type_.lockinfo_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::merge::LockInfo& Message::_internal_lockinfo() const {
  return _internal_has_lockinfo()
      ? *type_.lockinfo_
      : *reinterpret_cast< ::merge::LockInfo*>(&::merge::_LockInfo_default_instance_);
}
inline const ::merge::LockInfo& Message::lockinfo() const {
  // @@protoc_insertion_point(field_get:merge.Message.lockinfo)
  return _internal_lockinfo();
}
inline ::merge::LockInfo* Message::_internal_mutable_lockinfo() {
  if (!_internal_has_lockinfo()) {
    clear_type();
    set_has_lockinfo();
    type_.lockinfo_ = CreateMaybeMessage< ::merge::LockInfo >(
        GetArenaNoVirtual());
  }
  return type_.lockinfo_;
}
