...
//  TODO: check product name and version rather than driver name
  ...
  public void beginTransaction() throws SQLException {
    Connection connection = conns.get(random.nextInt(1000) % conns.size());
//    System.out.println("beginTransaction, connection = " + connection);
    connection.setAutoCommit(false);
  }

  // TODO: 初始化创建存储过程
  @Override
  public void createStoredProcedure(int ops) throws SQLException {
    Connection connection = conns.get(random.nextInt(1000) % conns.size());
    System.out.println("createStoredProcedure 1");
    System.out.println("createStoredProcedure 2");
  }

  // wzy 开启交互性事务
  @Override
  public void beginInteractiveTransaction(int retry_cnt) throws SQLException {

    Connection connection = conns.get(random.nextInt(1000) % conns.size());
//    System.out.println("beginTransaction Interactive, connection = " + connection);
    connection.setAutoCommit(true);
    Statement stmt = connection.createStatement();
    String sql = "";
    if (retry_cnt >= 10) sql = "1be" + retry_cnt + ";"; // 交互性事务开启语句
    else sql = "1be0" + retry_cnt +";";
//    sql = "1be12;";
//    System.out.println(sql);
  ...
  public void commitTransaction() throws SQLException {
    Connection connection = conns.get(random.nextInt(1000) % conns.size());
    // commit
    connection.commit();        // Aborts will throw Exception here
//     System.out.println("commitTransaction, connection = " + connection);
  }

  @Override
  public void commitInteractiveTransaction() throws SQLException {
    Connection connection = conns.get(random.nextInt(1000) % conns.size());
    // commit
//    System.out.println("commitTransaction Interactive, connection = " + connection);
    Statement stmt = connection.createStatement();
    String sql = "commit;"; // 交互性事务开启语句
    stmt.execute(sql);
  }
  ...
  public void rollbackTransaction() throws SQLException {
    ...
    // rollback
    connection.rollback();
//    System.out.println("rollbackTransaction, connection = " + connection);      // never rollback
  }

  // wzy
  @Override
  public void rollbackInteractiveTransaction() throws SQLException {
    Connection connection = conns.get(random.nextInt(1000) % conns.size());
    // commit
//    System.out.println("rollbackTransaction Interactive, connection = " + connection);
    Statement stmt = connection.createStatement();
    String sql = "rollback;"; // 交互性事务开启语句
    stmt.execute(sql);
  }
...
//    key = "key_value1";     // 测试！
    try {
      ...
      // wzy: 生成了sql
//      System.err.println("read sql = " + readStatement.toString());
...
//    System.out.println("scan");
    try {
      ...
      PreparedStatement scanStatement = getShardConnectionByKey(startKey).prepareStatement("SELECT * FROM " + tableName + " WHERE ycsb_key >= '" + startKey + "' LIMIT " + recordcount);
...
////        System.out.println("scan sql1: " + scanStatement);
//      } else {
//        scanStatement.setString(1, startKey);
//        scanStatement.setInt(2, recordcount);
//        System.out.println("scan sql: " + scanStatement);
//      }

//      long startTimeNano = System.nanoTime();
      ResultSet resultSet = scanStatement.executeQuery();
//      long endTimeNano = System.nanoTime();
//      System.out.println("YCSB scan executeQuery cost(ns): " + (endTimeNano - startTimeNano));
...
//      System.out.println("scan internal 2 spend(ns): " + (endTimeNano - startTimeNano));
//      System.out.println("scan result: " + result);
      resultSet.close();
      return Status.OK;
    } catch (SQLException e) {
      System.err.println("Error in processing scan of table: " + tableName + " err:" + e);
      return Status.ERROR;
    }
  }
...
//    key = "key_value4";     // 测试！
    try {
      ...
      // wzy: 生成了sql
//      System.err.println("update sql = " + updateStatement.toString());
...
//    System.out.println("insert values: " + values);
    try {
      int numFields = values.size();
      OrderedFieldInfo fieldInfo = getFieldInfo(values);
//      System.out.println("fieldKey: " + fieldInfo.fieldKeys + " fieldValue: " + fieldInfo.fieldValues);
...
//      System.out.println("sql before: " + insertStatement);
      insertStatement.setString(1, key);
      int index = 2;
      for (String value : fieldInfo.getFieldValues()) {
        insertStatement.setString(index++, value);
      }
//      System.out.println("sql after: " + insertStatement);
      ...
      System.err.println("Error in processing insert to table: " + tableName + " exception: " + e);
      return Status.ERROR;
    }
  }
