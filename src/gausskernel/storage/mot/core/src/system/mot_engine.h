 ...
 */
 ...
 private:
     ...
     /** @brief Initializes HybridCC components (logger and manager). */
     bool InitializeHybridCcComponents();
     ...
     /** @brief Destroys HybridCC components. */
     void DestroyHybridCcComponents();
