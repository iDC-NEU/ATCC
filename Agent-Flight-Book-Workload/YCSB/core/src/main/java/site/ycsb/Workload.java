...
public abstract class Workload {
   ...
   * traces from a file, return true when there are more to do, false when you are done.
   */
  public abstract boolean doTransaction(DB db, Object threadstate) throws SQLException;

  public abstract boolean doTransaction(DB db, Object threadstate, boolean interactive_) throws SQLException;

  public abstract boolean redoTransaction(DB db, Object threadstate, boolean retry, int tid, boolean interactive_) throws SQLException;   // add by wzy

  public abstract boolean redoTransactionResult(DB db, Object threadstate, boolean retry, int tid, boolean interactive_, int retryCnt_, boolean uniform_flag, boolean all_occ, boolean all_pcc) throws SQLException;   // add by wzy

  public abstract void switchProperty(int type);

  public abstract Long getSqlCnt(int tid);
  public abstract Long getSqlLatency(int tid);
  public abstract Long getTokenCost(int tid);
  public abstract List<AgentResp> getAgentResps(int tid);
  /**
